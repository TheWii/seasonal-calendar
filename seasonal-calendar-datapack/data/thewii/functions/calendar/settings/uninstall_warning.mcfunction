...
tellraw @s ["",{"text":"\n\n\n\n\n\n\n\n\n\n"}]
tellraw @s [{"text":"                  "},{"text":"[BACK]","color":"green","strikethrough":false,"bold":true,"clickEvent":{"action":"run_command","value":"/trigger SeasonalCalendar set 1"}},{"text":"                "},{"text":"[UNINSTALL]","color":"red","strikethrough":false,"bold":true,"clickEvent":{"action":"run_command","value":"/function thewii:calendar/uninstall"}}]
